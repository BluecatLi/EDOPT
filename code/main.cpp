...
public:
    ...
    bool configure(yarp::os::ResourceFinder& rf) override
    {
        ...
        cstep = rf.check("cstep") && rf.check("cstep", Value(true)).asBool();
        ...
        if (!scarf_handler.start(cv::Size(intrinsic_parameters.find("w").asInt32(), intrinsic_parameters.find("h").asInt32()), "/atis/AE:o", getName("/AE:i"), scarf_block, scarf_alpha, scarf_c)) {
    ...
    void sequential_loop()
    {
        ...
        while (!isStopping()) {
            ...
            static cv::Mat scaled_scarf = cv::Mat::zeros(img_size, CV_32F);
            ...
            if(run) {
                ...
                ros_publish.publishTargetPos(warp_handler.state_current[0],
                             warp_handler.state_current[1],
                             warp_handler.state_current[2],
                             warp_handler.state_current[3],
                             warp_handler.state_current[4],
                             warp_handler.state_current[5],
                             warp_handler.state_current[6]);
